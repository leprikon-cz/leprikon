    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agenda', djangocms_text_ckeditor.fields.HTMLField(default=leprikon.models.clubs.get_default_agenda, verbose_name='session agenda')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', leprikon.models.fields.PriceField(blank=True, decimal_places=0, default=0, max_digits=10, verbose_name='discount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_groups', models.ManyToManyField(blank=True, help_text='Keep empty to skip filtering by age groups.', to='leprikon.AgeGroup', verbose_name='age groups')),
                ('groups', models.ManyToManyField(blank=True, help_text='Keep empty to skip filtering by groups.', to='leprikon.ClubGroup', verbose_name='club groups')),
                ('leaders', models.ManyToManyField(blank=True, help_text='Keep empty to skip filtering by leaders.', to='leprikon.Leader', verbose_name='leaders')),
            ],
            bases=('cms.cmsplugin',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='Keep empty to skip filtering by groups.', to='leprikon.EventGroup', verbose_name='event groups')),
                ('leaders', models.ManyToManyField(blank=True, help_text='Keep empty to skip filtering by leaders.', to='leprikon.Leader', verbose_name='leaders')),
            ],
            bases=('cms.cmsplugin',),
        ),
